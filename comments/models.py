...
class Comment(models.Model):
    sender_name = models.CharField(default='user', max_length=255)  # Имя пользователя из ВК
    content = models.TextField()  # Текст комментария
    created_at = models.DateTimeField()  # Дата создания комментария
    status = models.CharField(max_length=50, default='new')  # Статус создания комментария
